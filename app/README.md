...
This project was bootstrapped with [jsonforms-react-seed](https://github.com/eclipsesource/jsonforms-react-seed).
...
It is based on [Create React App](https://github.com/facebook/create-react-app) and only contains minor modifications.
